...
/*
 * EzNginxAuthModuleBase.h
 *
 *  Created on: May 21, 2014
 *      Author: oarowojolu
 */

#ifndef EZNGINXAUTH_EZNGINXAUTHMODULEBASE_H_
#define EZNGINXAUTH_EZNGINXAUTHMODULEBASE_H_
...
extern ngx_module_t ngx_http_eznginx_auth_module;


namespace ezbake { namespace eznginx {


class EzNginxAuthModuleBase {
public: //types
...
#endif /* EZNGINXAUTH_EZNGINXAUTHMODULEBASE_H_ */
